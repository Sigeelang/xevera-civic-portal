 ...
 * Shared helper (middleware/penalty_enforcement.php): suspended
 * (Inactive) accounts and active reporting restrictions block submit.
 */
require_once __DIR__ . '/../middleware/penalty_enforcement.php';
if ($reporterUserId !== null) {
    $block = xevera_reporting_block($pdo, (int)$reporterUserId);
    if ($block !== null) {
