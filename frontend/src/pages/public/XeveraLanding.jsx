      ...
      <section className="relative w-full overflow-hidden">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(100deg, rgba(8,28,72,0.95) 0%, rgba(8,28,72,0.78) 35%, rgba(8,28,72,0.22) 70%, rgba(8,28,72,0) 100%)',
            }}
            aria-hidden="true"
          />
          <div className="relative z-10 w-full pl-6 pr-6 sm:pl-8 sm:pr-6 md:pl-12 md:pr-8 lg:pl-16 lg:pr-12 max-w-3xl flex flex-col justify-center">
            ...
            <h1 className="mt-4 sm:mt-4 text-[clamp(40px,7vw,56px)] font-head font-extrabold text-white leading-[1.05] sm:leading-[1.1] tracking-[-0.5px] [text-shadow:0_2px_18px_rgba(8,28,72,0.55)]">
              Building a Better
              <br className="hidden sm:inline" />
              <span className="sm:inline"> Xevera Together</span>
            </h1>
            <p className="mt-3 sm:mt-3 max-w-xl text-[16px] sm:text-[15px] md:text-[16px] text-white/90 leading-[1.55] sm:leading-relaxed [text-shadow:0_1px_10px_rgba(8,28,72,0.6)]">
