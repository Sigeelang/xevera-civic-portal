...
export default function HelpCenterPage() {
  ...
  useEffect(() => {
    ...
    apiFetch('settings/get.php').then(d => {
      setContact({
        address: d.barangay_address || 'Barangay Hall, San Isidro, Xevera',
      ...
      <div className="mt-6 pt-6 border-t border-[#E5E7EB]">
        ...
        <div className="bg-white rounded-[18px] border border-[#E5E7EB] shadow-[0_1px_3px_rgba(16,24,40,0.06),0_4px_12px_rgba(16,24,40,0.06)] p-5">
          <div className="space-y-2 text-sm text-[#6B7280]">
            <p><span className="font-bold text-[#111827]">Address:</span> {contact?.address || 'Barangay Hall, San Isidro, Xevera'}</p>
