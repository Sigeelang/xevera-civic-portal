          ...
          <form onSubmit={handleSave}>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <label className="block">
                ...
                <input className={inputCls} type="tel" inputMode="numeric" maxLength={11} value={form.phone} onChange={e => setForm({ ...form, phone: formatPhoneLive(e.target.value) })} onBlur={e => setForm({ ...form, phone: normalizePhMobile(e.target.value) })} placeholder="09XX XXX XXXX" />
              </label>
              <label className="block">
