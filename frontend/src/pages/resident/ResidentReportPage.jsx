    ...
    <ResidentLayout activePage="submit" onNavigate={onNavigate}>
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_304px] gap-[18px] items-start">
          {/* ---- Form ---- */}
          <form onSubmit={handleSubmit} className="bg-white border border-[#E4EAF3] rounded-[17px] px-5 sm:px-[30px] pt-[23px] pb-[18px] shadow-[0_7px_24px_rgba(25,55,100,0.05)]">
            {/* Alerts */}
            {successRef && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[18px]">
              ...
              <div>
                ...
                <input id="ri-contact" type="text" value={contact} onChange={(e) => setContact(e.target.value)} placeholder="Phone number or email address" className={inputCls} />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full h-[43px] mt-4 rounded-[10px] border-0 text-white text-[13px] font-extrabold cursor-pointer disabled:opacity-60 hover:-translate-y-[1px] transition-all"
